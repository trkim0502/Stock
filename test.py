...
# slack.chat.post_message('#stockbot', '삼성전자 매도호가 : ' )
...
post_message(myToken,'#stockbot', '삼성전자 매도호가 : ' + str(offer))
post_message(myToken,'#stockbot', '삼성전자 매수호가 : ' + str(bid))
post_message(myToken,'#stockbot', '삼성전자 시가 : ' + str(open))
post_message(myToken,'#stockbot', '삼성전자 거래량 : ' + str(vol))
